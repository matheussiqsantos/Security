 ...
 */
package br.dev.matheus.security;

import br.dev.matheus.security.jwt.JwtTokenFilter;
import br.dev.matheus.security.repositories.UserRepository;
   ...
   WebSecurityCustomizer webSecurityCustomizer() {
    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authz) -> authz
                ...
                .requestMatchers("/manager").hasRole("ADMIN") // ROLE_ADMIN
